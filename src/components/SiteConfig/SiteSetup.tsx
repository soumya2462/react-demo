...
export type SiteSetupProps = {
  handleSaveSiteButton: (site: apiSite, packagesValue: string, packages: Array<string>) => void;
...
const SiteSetup = (props: SiteSetupProps) => {
  const { handleSaveSiteButton, saveButtonLabel, validationError, pageTitle, passedInSite } = props;
    ...
    axios
      ...
      .then((response) => {
        if (response.status === 200) {
          setPackages(
            response.data.map((packageToSelect: apiPackage) => ({
              id: packageToSelect.packageId,
              name: packageToSelect.name,
            }))
          );
        }
      })
  ...
  return (
    <ContentLayout title={pageTitle} data-test="component-site-setup">
      <Paper elevation={2}>
        <div className={classes.form}>
          <div className={classes.accordionWrapper}>
            {validationError !== '' && (
              <Alert severity="error" data-test="site-details-validation">
                {validationError}
              </Alert>
            )}
            <Accordion defaultExpanded>
              ...
              >
                <Typography variant="subtitle2" data-test="site-details-accordion-label">
                  Site Details
                </Typography>
              </AccordionSummary>
              <AccordionDetails data-test="site-details-accordion-details">
                <Grid container spacing={3}>
                  <Grid item xs={12}>
                    <Typography data-test="site-name-label" variant="subtitle2" align="left">
                      Name
                    </Typography>
                    <TextField
                  ...
                  <Grid item xs={12} md={12} lg={12}>
                    <Typography data-test="site-sub-domain-label" variant="subtitle2" align="left">
                      Site URL
                    </Typography>
                    <Grid container>
          ...
          <div className={classes.accordionWrapper}>
            <Accordion defaultExpanded>
              <AccordionSummary
                ...
                className={classes.accordionHeader}
              >
                <Typography variant="subtitle2" data-test="site-packages-accordion-label">
                  Packages
                </Typography>
              </AccordionSummary>
              <AccordionDetails data-test="site-packages-accordion-details">
                <Grid container spacing={3}>
                  <Grid item xs={12}>
                    <Typography data-test="site-packages-label" variant="subtitle2" align="left">
                    ...
                    >
                      <FormControlLabel
                        ...
                        label={
                          <Typography variant="subtitle2" data-test="site-packages-all-label">
                            All
                          </Typography>
                        }
                      />
                      <FormControlLabel
                        ...
                        label={
                          <Typography variant="subtitle2" data-test="site-packages-some-label">
                            Specific packages
                          </Typography>
                        }
                      />
          ...
          <div className={classes.accordionWrapper}>
            <Accordion defaultExpanded>
              <AccordionSummary
                ...
                className={classes.accordionHeader}
              >
                <Typography variant="subtitle2" data-test="site-audience-accordion-label">
                  Audience
                </Typography>
              </AccordionSummary>
              <AccordionDetails data-test="site-audience-accordion-details">
                <Grid container spacing={3}>
                  <Grid item xs={12}>
                    <Typography data-test="site-audience-label" variant="subtitle2" align="left">
                    ...
                    >
                      <FormControlLabel
                        ...
                        control={
                          <Radio
                            data-test="site-audience-public-radio"
                            size="small"
                            color="primary"
                            value="Public"
                            checked={siteToSave.audience === 'Public'}
                          />
                        }
                      ...
                      <FormControlLabel
                        ...
                        control={
                          <Radio
                            data-test="site-audience-agent-radio"
                            size="small"
                            color="primary"
                            value="Agent"
                            checked={siteToSave.audience === 'Agent'}
                          />
                        }
